...
public class CentresController {
    ...
    //Remember to make a recycling-centre page
    ...
    //adding a new recycling centre from website to database
    @PostMapping("/centres/new")
    public String addRecyclingCenter(@Valid @ModelAttribute("centre")  RecyclingCentre centre, BindingResult bindingResult) {
